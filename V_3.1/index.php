    ...
    <div class="main-card">
        ...
        <div class="form-section">
            <?php if (isset($_GET['status'])): ?>
                ...
                <?php else: ?>
                    <div class="alert-custom" style="background: #fff5f5; color: #d32f2f; border-color: #d32f2f;">❌ Error en el
                        registro (Cód: <?= htmlspecialchars($_GET['msg'] ?? '403') ?>).</div>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <form action="guardar_nueva.php" method="POST">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <label class="form-label">Fecha de Creación (Hoy)</label>
                        <input type="date" name="fecha_creacion" id="fecha_creacion" class="form-control"
                            value="<?= $fecha_hoy ?>" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Previsualización de Próximo Vencimiento</label>
                        <input type="date" id="fecha_vencimiento_vista" class="form-control" disabled>
                        <small class="text-muted" style="font-size: 10px;">* Calculado automáticamente sugún la
                            periodicidad seleccionada.</small>
                    </div>
                </div>
